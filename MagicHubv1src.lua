...
do
    function Utility:Log(Type, Message)
        ...
        if Type == 'error' then
            error('[ MagicHubv1 ] Error: ' .. Message)
        elseif Type == 'log' then
            print('[ MagicHubv1 ] ' .. Message)
        elseif Type == 'warn' then
            warn('[ MagicHubv1 ] Warning: ' .. Message)
        end
    end
    ...
    function Utility:EnableDragging(Frame, Parent)
        ...
        local Main = CoreGui:FindFirstChild('MagicHubv1').Main
...
function Library:CreateWindow(Properties)
    -- // Properties
    local Name = Utility:GetProperty('Window', 'Name', Properties) or 'MagicHubv1'
    local IntroText = Utility:GetProperty('Window', 'IntroText', Properties) or 'MagicHubv1'
    ...
    local function Execute(String)
        ...
        local Command = assert(Commands[First], '[MagicHubv1]  Not Found: ' .. First)
